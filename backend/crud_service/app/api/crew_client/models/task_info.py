...
class TaskInfo:
    ...
    reads: list[TaskFieldRead]
    writes: list[TaskFieldWrite]
    crew_inputs: None | str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        crew_inputs: None | str | Unset
        if isinstance(self.crew_inputs, Unset):
            crew_inputs = UNSET
        else:
            crew_inputs = self.crew_inputs
        ...
        if crew_inputs is not UNSET:
            field_dict["crew_inputs"] = crew_inputs
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_crew_inputs(data: object) -> None | str | Unset:
            if data is None:
                return data
        ...
        crew_inputs = _parse_crew_inputs(d.pop("crew_inputs", UNSET))
