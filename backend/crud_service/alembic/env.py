...
from app.schemas.schemas import Base, User, Crew, Task, CrewRun, Artifact, CrewRunQueue
...
def run_migrations_online() -> None:
    ...
    if "${" in url:
        raise ValueError(
            f"Database URL still contains unsubstituted placeholders: {url}. "
            "Make sure environment variables are set and .env file is loaded."
        )
