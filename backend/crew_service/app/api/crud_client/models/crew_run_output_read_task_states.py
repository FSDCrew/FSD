...
T = TypeVar("T", bound="CrewRunOutputReadTaskStates")


@_attrs_define
class CrewRunOutputReadTaskStates:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        crew_run_output_read_task_states = cls()
        ...
        crew_run_output_read_task_states.additional_properties = additional_properties
        return crew_run_output_read_task_states
